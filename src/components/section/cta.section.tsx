...
const CTA = () => {
  return (
    <SectionWrapper className="mt-6 sm:mt-8 md:mt-10 min-h-[60vh] sm:min-h-80 md:min-h-96 rounded-2xl sm:rounded-3xl flex items-center justify-center text-black bg-gradient-to-tr from-primary-300 to-primary-400 px-4 sm:px-6">
