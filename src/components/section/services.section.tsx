...
const Service = () => {
  return (
    <SectionWrapper className="py-10 md:py-20 bg-white flex flex-col items-center justify-center gap-4 md:gap-8">
                          ...
                          <div className="flex flex-wrap gap-1.5 md:gap-2">
                            <ListComponent
                              ...
                              renderItem={(item, indexx) => (
                                <div
                                  key={indexx}
                                  className="rounded-full bg-white text-black px-3 md:px-4 py-1 md:py-1.5 text-xs md:text-sm"
                                >
                                  <span>{item}</span>
                                </div>
                              )}
